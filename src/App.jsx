  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ textAlign: 'center', mt: 4 }}>
        ...
        <Box sx={{ textAlign: 'center', mt: 4 }}>
        <Typography variant="subtitle1" color="initial" style={{ fontSize: '1.5rem',backgroundColor: '#f0f0f0', padding: '10px', borderRadius: '5px' }}>
          Free Delievery Service in j3 Block Johar Town
        </Typography>
        <Typography variant="subtitle1" color="initial">Home Delivery Available</Typography>
        </Box>
      </Box>
